...
GameConfig.OfficeUpgrades = {
	{
		...
		price       = 0,
		incomeRate  = 1,
		imageId     = "rbxthumb://type=Asset&id=6277375466&w=420&h=420",  -- Laptop / computer icon (Roblox catalog)
		order       = 1,
	},
	{
		id          = "Garage Office",
		...
		price       = 500,
		incomeRate  = 10,
		imageId     = "rbxthumb://type=Asset&id=2948768&w=420&h=420",     -- Roblox Building Decal D / garage structure (roblox.com/library/2948768)
		order       = 2,
	},
	{
		id          = "Startup Office",
		...
		price       = 2500,
		incomeRate  = 50,
		imageId     = "rbxthumb://type=Asset&id=5539575&w=420&h=420",     -- Roblox Castle / small office building (roblox.com/library/5539575)
		order       = 3,
	},
	{
		id          = "Tech Campus",
		...
		price       = 15000,
		incomeRate  = 200,
		imageId     = "rbxthumb://type=Asset&id=317674349&w=420&h=420",   -- Mad Games Map / tech campus grounds (roblox.com/library/317674349)
		order       = 4,
	},
	{
		id          = "Skyscraper HQ",
		...
		price       = 100000,
		incomeRate  = 500,
		imageId     = "rbxthumb://type=Asset&id=2215219927&w=420&h=420",  -- Castle 2 / tall structure (roblox.com/library/2215219927)
		order       = 5,
	},
	{
		id          = "Global HQ",
		...
		price       = 1000000,
		incomeRate  = 1000,
		imageId     = "rbxthumb://type=Asset&id=20379895&w=420&h=420",    -- Space Decal 2 / global scene (roblox.com/library/20379895)
		order       = 6,
	},
}
...
GameConfig.Employees = {
	{
		...
		price       = 1000,
		incomeBonus = 5,      -- +$5/s
		imageId     = "rbxthumb://type=Asset&id=174792017&w=420&h=420",   -- Statue / young developer figure (roblox.com/library/174792017)
	...
	},
	{
		...
		price       = 5000,
		incomeBonus = 20,     -- +$20/s
		imageId     = "rbxthumb://type=Asset&id=392990034&w=420&h=420",   -- Personal Statue / experienced figure (roblox.com/library/392990034)
	...
	},
	{
		...
		imageId     = "rbxthumb://type=Asset&id=415565819&w=420&h=420",   -- Aesthetic Statue / tech manager (roblox.com/library/415565819)
		autoCollect = true,
	...
	},
	{
		...
		imageId     = "rbxthumb://type=Asset&id=43118538&w=420&h=420",    -- Roblox Golden Statue / prestigious executive (roblox.com/library/43118538)
